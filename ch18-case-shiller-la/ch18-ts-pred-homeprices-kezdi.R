...
#############################
# TABLE 18.3 
# rmse by folds, cv rmse, for all 7 modesl
...
## ITT AZT SZERETNEM, hogy a summary_folds matrixbol, ami fleds MSE,
## csinaljon egy summary_rmse_folds matroxit, aminek minden eleme az MSE negyzetgyoke
# mem kell semmi formazas, majd csak kilistazzuk a matrixot
summary_rmse_folds <- summary_folds
summary_rmse_folds

  
# ez csinalja a cv average rmse-t
