...
* prices
tsline p_MSFT, lcolor("68 1 84") lwidth(medium) /// 
...
* prices
tsline p_MSFT, lcolor("68 1 84") lwidth(thick) /// 
...
tsline r_MSFT, lcolor("68 1 84") lwidth(thick) /// 
...
scatter r_MSFT r_SP500, ms(O) mc("68 1 84") ///
 || lfit r_MSFT r_SP500, lw(vthick ) lc("253 231 37")  ///
...
* time series jointly
* entire time period
tsline r_MSFT r_SP500, lc("68 1 84" "253 231 37") lw(medthick medthick) ///
