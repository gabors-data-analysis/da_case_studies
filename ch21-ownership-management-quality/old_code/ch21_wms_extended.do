...
clear
set matsize 4000
use "$data_in/wms_2004_2010.dta",replace
...
save "$data_out/Ch21_wms_workfile.dta",replace
...
* SOLUTION #1 (No replacement)
* a) Without employment
use "$data_out/Ch21_wms_workfile.dta" ,clear
global RHS1 degree_nm degree_nm_sq compet_moder compet_strong
* Step 1 - Matching
psmatch2 foundfam $RHS1 i.industry i.countrycode, n(1) noreplacement logit
...
global RHS1 degree_nm degree_nm_sq compet_moder compet_strong
* Step 1 - Matching
psmatch2 foundfam $RHS1 i.industry i.countrycode lnemp, n(1) noreplacement logit
* Step 2 & 3 - Keep only matched untreated & calculate ATE
reg management foundfam_owned if (_treated==0 & _weight!=.) | _treated==1 
...
global RHS1 degree_nm degree_nm_sq compet_moder compet_strong
* Step 1 - Matching
psmatch2 foundfam $RHS1 i.industry i.countrycode, n(1) logit
* Step 2 & 3 - Keep only matched untreated & calculate ATE
reg management foundfam_owned if (_treated==0 & _weight!=.) | _treated==1 
...
* SOLUTION #3 (with teffects)
* a) Without employment
use "$data_out/Ch21_wms_workfile.dta" ,clear
global RHS1 degree_nm degree_nm_sq compet_moder compet_strong
teffects psmatch (management) (foundfam $RHS1 i.industry i.countrycode, logit), gen(ps1x) nn(1) ate
teffects overlap

* b) With employment
use "$data_out/Ch21_wms_workfile.dta" ,clear
global RHS1 degree_nm degree_nm_sq compet_moder compet_strong
teffects psmatch (management) (foundfam $RHS1 i.industry i.countrycode lnemp, logit), gen(ps1x) nn(1) ate
teffects overlap
...
cvlasso management $RHS1 i.industry i.countrycode, seed(24367) lopt 
cvlasso foundfam $RHS1 i.industry i.countrycode, seed(24367) lopt
