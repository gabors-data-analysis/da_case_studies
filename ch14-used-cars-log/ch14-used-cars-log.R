...
#            example data_dir="C:/Users/xy/Dropbox/gabors_data_analysis/da_data_dir"
...
# DATA IMPORT
 ...
 # data <- read.csv( 'https://osf.io/download/7gvz9/', stringsAsFactors = TRUE)
...
Ch14_p_age_lowess_R <- ggplot(data = data, aes(x = age, y = price)) +
  ...
  geom_smooth(formula = y ~ x, method="loess", color=color[2], se=F, linewidth=0.8, na.rm=T)+
